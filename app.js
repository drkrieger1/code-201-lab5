...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var sumProd = sum(sum(a,b)[0],c)[0];
  var multiProd = multiply(multiply(a,b)[0],c)[0];
  var thirdElMsg = a + ' and ' + b + ' and ' + c + ' sum to ' + sumProd + '.';
  var fourthElMsg = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiProd + '.';
  return[sumProd, multiProd, thirdElMsg, fourthElMsg];
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var testARsum = sum(sum(a,b)[0],c)[0];
  var message = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + testARsum + ' is their sum.';
  return[testARsum, message];
}
